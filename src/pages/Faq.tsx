    ...
    return (
        <>
            <main className='faq-main'>
                <h1 className="h1-title text-center text-uppercase">Faq</h1>
                <div className="page-breadcrumbs d-f">
                    ...
                    <p className="cur-page text-uppercase">Faq</p>
                </div>
            </main>
            <div className="faq-main-line"></div>
            <section className='faq-content'>
                ...
                <div className="faq-tabs d-f">
                    <button className='tab-btn tab-btn__active'>All</button>
                    <button className='tab-btn'>VR Service</button>
                    <button className='tab-btn'>Pricing</button>
                </div>
            ...
            <section className='faq-subscribe d-f jc-sb align-center'>
                <h3 className="faq-subscribe-title">
                    Subscribe to our newsletter for latest updates
                </h3>
                <form action="" className='faq-subscribe-fm d-f jc-sb'>
